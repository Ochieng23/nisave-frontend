    ...
    <footer className="bg-slate-50">
      <Container>
        <div className="py-16">
          ...
          <svg className="mx-auto h-10 w-auto" width="56" height="29" viewBox="0 0 96 79" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M76.0385 78.2104C88.279 70.776 94.2791 57.8161 95.5911 43.4502C86.9897 39.1642 68.6131 50.658 60.3958 56.4848" fill="#E61F53"/>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Nisave. All rights
            reserved.
          </p>
        </div>
      </Container>
